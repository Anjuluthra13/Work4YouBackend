...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors() // Enable CORS
            ...
            .csrf().disable()
            .authorizeRequests()
            .requestMatchers("/api/auth/register", "/api/auth/login", "/error", "/admin/**", "/api/feedback/**","/api/hire","/api/local","/api/book-now","/api/orders","/api/contact").permitAll() // Allow registration, login, and error page
